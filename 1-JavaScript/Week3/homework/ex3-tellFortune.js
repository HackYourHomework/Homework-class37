...
function main() {
  ...
  const partnerNames = ["john","tony","hasan","wong","ted"];

  const locations = ["breda","telbourg","amesterdam","denhag","rotterdam"];

  const jobTitles = ["ICT specialist", "Clerk","FICO","CIO","Director"];
