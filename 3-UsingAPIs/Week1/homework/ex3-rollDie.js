...
// No, the problem described doesn't occur any more, But now will run into an error.
// why is that? Because we are using promise, which give us an advantage to use reject in case something goes wrong, the executor should be call {reject}.
