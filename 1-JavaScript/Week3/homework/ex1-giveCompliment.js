...
-----------------------------------------------------------------------------*/
function giveCompliment(str) {
  let compliments =['great', 'awesome','good','hero','marvellous','fantastic','terrific','grand','brilliant','excellent'];
  let randomCompliment= compliments[Math.floor(Math.random()*compliments.length)]
   return 'you are'+ " "+ randomCompliment +" " + str;
}
console.log( giveCompliment('ahmed'));
console.log( giveCompliment('ahmed'));
console.log( giveCompliment('ahmed'));
