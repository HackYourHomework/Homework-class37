...
function main() {
  ...
  const partnerNames = ['sara', 'nina', 'ali', 'mohamed', 'bo'];
  const locations = ['amsterdam', 'miami', 'switzerland', 'hawaii', 'bali'];
  const jobTitles = ['web developer', 'software developer', 'dentist', 'makeup artist', 'bartender'];
