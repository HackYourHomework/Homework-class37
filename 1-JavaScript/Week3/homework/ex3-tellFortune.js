...
function main() {
  const numKids = [2, 7, 9, 4, 1
    // TODO add elements here
  ];

  const partnerNames = ['james', 'rich', 'dav', 'paul', 'jack'
    // TODO add elements here
  ];

  const locations = ['amsterdam', 'rotterdam', 'leiden', 'arnhem', 'gouda'
    // TODO add elements here
  ];

  const jobTitles = ['teacher', 'cleaner', 'lawyer', 'developer', 'dok'
    // TODO add elements here
  ];
